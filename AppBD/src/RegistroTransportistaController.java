...
public class RegistroTransportistaController {
    ...
    @FXML
    private TextField tipoLicenciaField;
    @FXML
    private TextField zonaCoberturaField;
    @FXML
    ...
    private void onRegistrarClicked() {
        ...
        new Thread(() -> {
            ...
            payload.put("numeroLicencia", numeroLicenciaField.getText());
            payload.put("tipoLicencia", tipoLicenciaField.getText());
            payload.put("zonaCobertura", zonaCoberturaField.getText());
            payload.put("disponibilidad", disponibilidadField.getText());
            payload.put("role", "DRIVER");

            Request request = new Request(ProtocolActions.REGISTER_DRIVER, payload);
