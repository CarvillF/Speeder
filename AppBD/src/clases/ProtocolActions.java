...
public class ProtocolActions {
    ...
    public static final String REGISTER_BUSINESS = "REGISTER_BUSINESS";
    public static final String REGISTER_DRIVER = "REGISTER_DRIVER";

    public static final String GET_MY_SHIPMENTS = "GET_MY_SHIPMENTS";
    public static final String CREATE_SHIPMENT = "CREATE_SHIPMENT";
    public static final String DELETE_SHIPMENT = "DELETE_SHIPMENT";
    public static final String UPDATE_SHIPMENT_LOCATION = "UPDATE_SHIPMENT_LOCATION";
